                                                                        ...
                                                                        std::size_t selectedMolecule)
{
  ...
  if (system.numberOfIntegerMoleculesPerComponent[selectedComponent] > 0)
  {
    ...
    const RunningEnergy acceptedEnergyDifference =
        system.useMBX ? energyDifference : energyDifference - internalEnergyOld;
    ...
    if (random.uniform() < biasTransitionMatrix * Pacc)
    {
      ...
      system.writeAcceptedEnergyLog("deletion", selectedComponent, totalEnergyForLog,
      ...
      return {-acceptedEnergyDifference, double3(Pacc, 1.0 - Pacc, 0.0)};
    };
    return {std::nullopt, double3(Pacc, 1.0 - Pacc, 0.0)};
  }
